...
def build_from_train_config(
    ...
    datamodule = train.build_and_register_datamodule_from_config(config, **datamodule_kwargs)
    model = train.build_model_from_config(config, checkpoint_path, checkpoint_hook)
